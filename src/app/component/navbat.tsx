    ...
    <nav className="bg-black text-white shadow-md ">
      <div className="container mx-auto px-6 lg:px-12 py-4 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center justify-between flex-1 ml-8">
          ...
          <div className="flex space-x-6">
            ...
            <a href="/error" className="hover:text-orange-500 transition">Pages</a>
            ...
            <a href="/sinpup" className="hover:text-orange-500 transition">
              singup
            </a>
          </div>
      ...
      >
        ...
        <div className="flex flex-col space-y-4">
          ...
          <a href="../src/about" className="hover:text-orange-500 transition">
            About
          </a>
          <a href="#shop" className="hover:text-orange-500 transition">
            Shop
        ...
        <div>
          <a href="/shop">ftc
          <PiHandbagBold className="text-white text-2xl hover:text-orange-500 transition" />
          </a> <a href="/shop" className="text-white hover:text-orange-500 transition">Your Order</a>
        </div>
      </div>
    </nav>
  );
